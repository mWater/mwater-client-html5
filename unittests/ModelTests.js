...
function ModelTests(model) {
    ...
    asyncTest("queryNearby location", function() {
        model.transaction(function (tx){
            resetdb(tx);
            model.insertRow(tx, "sources", { uid: "uid1", code: "code1" });
            model.insertRow(tx, "sources", { uid: "uid2", code: "code1", latitude: 1, longitude: 1 });
            model.insertRow(tx, "sources", { uid: "uid3", code: "code1", latitude: 1, longitude: 2 });
            model.insertRow(tx, "sources", { uid: "uid4", code: "code1", latitude: 1, longitude: 10 });
        }, error,
        function() {
    ...
    asyncTest("queryNearby filter", function() {
        model.transaction(function (tx){
            ...
            model.insertRow(tx, "sources", { uid: "uid1", code: "code1" });
            model.insertRow(tx, "sources", { uid: "uid2", code: "code1", latitude: 1, longitude: 1 });
            model.insertRow(tx, "sources", { uid: "uid3", code: "code1", name: "abc", latitude: 1, longitude: 2 });
            model.insertRow(tx, "sources", { uid: "uid4", code: "code1", name: "xyz", latitude: 1, longitude: 10 });
        }, error,
        function() {
    ...
    asyncTest("Update source and query", function() {
        ...
        function() {
            model.queryNearbySources(0, 0, "", function(rows) {
                equal(rows.length, 1);
                model.transaction(function(tx) {
                   model.updateRow(tx, rows[0], { code: "code2"}); 
                }, error, function() {
                    model.queryNearbySources(0, 0, "", function(rows) {
    ...
    asyncTest("Insert tests and query", function() {
        model.transaction(function (tx){
            resetdb(tx);
            model.insertRow(tx, "tests", { uid: "uid1", test_type: 1, created_by: "usr1" });
            model.insertRow(tx, "tests", { uid: "uid2", test_type: 1, created_by: "usr2" });
            model.insertRow(tx, "tests", { uid: "uid3", test_type: 2, created_by: "usr1" });
        }, error,
        function() {
    ...
    asyncTest("Insert tests with sample and query", function() {
        model.transaction(function (tx){
            resetdb(tx);
            model.insertRow(tx, "samples", { uid: "uids1", desc: "desc1" });
            model.insertRow(tx, "tests", { uid: "uidt1", test_type: 1, sample: "uids1", created_by: "usr1" });
        }, error,
        function() {
            model.queryTests("usr1", function(rows) {
                equal(rows.length, 1);
    ...
    asyncTest("Insert tests with sample+source and query", function() {
        model.transaction(function (tx){
            resetdb(tx);
            model.insertRow(tx, "sources", { uid: "uidss1", code: "1234" });
            model.insertRow(tx, "samples", { uid: "uids1", source: "uidss1", desc: "desc1" });
            model.insertRow(tx, "tests", { uid: "uidt1", test_type: 1, sample: "uids1", created_by: "usr1" });
        }, error,
        function() {
            model.queryTests("usr1", function(rows) {
